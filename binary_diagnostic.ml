...
let frequencies data =
  ...
  fold_left (map2 ( + )) init_counts (map (map Bool.to_int) data)
...
let answer_one = solve_one data
let answer_two = solve_two data
